...
-- =============================================
-- FIX LỖI KHÔNG GÂY DAMAGE - THÊM CÁC HÀM ATTACK MỚI
-- =============================================

-- Hàm attack mới thay thế AttackNoCoolDown
function NewAttack()
    print("✅ Hàm NewAttack được định nghĩa")
    pcall(function()
        ...
        local attackRemote = ReplicatedStorage:FindFirstChild("Remotes") and 
                             ReplicatedStorage.Remotes:FindFirstChild("Combat") and 
                             ReplicatedStorage.Remotes.Combat:FindFirstChild("Attack")
        
        if attackRemote then
            attackRemote:FireServer()
        end
        
        -- Cách 3: Kích hoạt tool đang cầm
...
-- Hàm Auto Haki cải tiến
function AutoHaki()
    print("✅ Hàm AutoHaki được định nghĩa")
    pcall(function()
        local player = game:GetService("Players").LocalPlayer
...
-- Hàm equip vũ khí cải tiến
function EquipWeapon(weaponName)
    print("✅ Hàm EquipWeapon được định nghĩa")
    pcall(function()
        local player = game:GetService("Players").LocalPlayer
...
-- 🟢 Toggle state
local toggled = true  -- true = menu đang mở

v23.MouseButton1Down:Connect(function()
    -- Hiệu ứng hạt
    v25.Rate = 100;
    task.delay(1, function() v25.Rate = 0; end);

    -- Xoay nút
    v26:Create(v23, TweenInfo.new(0.5), {Rotation = 360}):Play()
    
    -- Gửi phím End (nếu cần)
    game:GetService("VirtualInputManager"):SendKeyEvent(true, Enum.KeyCode.End, false, game);

    -- XỬ LÝ TOGGLE MENU
    if toggled then
        -- Tắt menu: ẨN đi, KHÔNG DESTROY
        toggled = false
        
        -- Ẩn cửa sổ Fluent
        if Fluent and Fluent.Window then
            Fluent.Window.Root.Visible = false
        end
        
        -- Hiệu ứng nút: thu nhỏ + trong suốt
        v23.BackgroundTransparency = 0.5
        v26:Create(v23, TweenInfo.new(0.2, Enum.EasingStyle.Bounce), {
        ...
        -- Hiện cửa sổ Fluent
        if Fluent and Fluent.Window then
            Fluent.Window.Root.Visible = true
        end
        
        -- Hiệu ứng nút: phóng to + đặc
                        ...
                        if (v1433:FindFirstChild("Humanoid") and v1433:FindFirstChild("HumanoidRootPart") and (v1433.Humanoid.Health > 0)) then
                            if (v1433.Name == Ms) then
                                repeat
                                    ...
                                    v1433.HumanoidRootPart.Size = Vector3.new(120, 120, 120);
                        ...
                        if v839.Name then
                            if ((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v839:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 5000) then
                                repeat
                                    ...
                                    v839.HumanoidRootPart.Size = Vector3.new(120, 120, 120);
                        ...
                        if (_G.CastleRaid and v1031:FindFirstChild("HumanoidRootPart") and v1031:FindFirstChild("Humanoid") and (v1031.Humanoid.Health > 0)) then
                            if ((v1031.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000) then
                                repeat
                                    ...
                                    v1031.HumanoidRootPart.Size = Vector3.new(120, 120, 120);
                        ...
                        if ((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v843:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 5000) then
                            repeat
                                ...
                                if (v843.Humanoid.Health <= ((v843.Humanoid.MaxHealth * KillPercent) / 100)) then
                                    ...
                                    v843.HumanoidRootPart.Size = Vector3.new(100, 100, 100);
                                    ...
                                    if ((v1662.Name == "Reborn Skeleton") or (v1662.Name == "Living Zombie") or (v1662.Name == "Demonic Soul") or (v1662.Name == "Posessed Mummy")) then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Demonic Soul") then
                                            repeat
                                                ...
                                                v1662.HumanoidRootPart.Size = Vector3.new(100, 100, 100);
                            ...
                            if (v1437:FindFirstChild("HumanoidRootPart") and v1437:FindFirstChild("Humanoid") and (v1437.Humanoid.Health > 0)) then
                                if ((v1437.Name == "Reborn Skeleton") or (v1437.Name == "Living Zombie") or (v1437.Name == "Demonic Soul") or (v1437.Name == "Posessed Mummy")) then
                                    repeat
                                        ...
                                        v1437.HumanoidRootPart.Size = Vector3.new(100, 100, 100);
                                ...
                                if ((v1755.Name == "Cookie Crafter") or (v1755.Name == "Cake Guard") or (v1755.Name == "Baking Staff") or (v1755.Name == "Head Baker")) then
                                    if (v1755:FindFirstChild("Humanoid") and v1755:FindFirstChild("HumanoidRootPart") and (v1755.Humanoid.Health > 0)) then
                                        repeat
                                            ...
                                            v1755.HumanoidRootPart.Size = Vector3.new(100, 100, 100);
            ...
            if (# v758 > 0) then
                ...
                if (v886:IsA("Model") and v886.PrimaryPart) then
                    ...
                    if (v1129 <= 1) then
                        ...
                        game:GetService("VirtualInputManager"):SendKeyEvent(false, "E", false, game);
-- =============================================
-- NÚT BẤM PHỤ ĐƠN GIẢN CHO ANDROID
-- =============================================

-- Xóa nút cũ nếu có
pcall(function()
    if game.CoreGui:FindFirstChild("SimpleFloatingButton") then
        game.CoreGui.SimpleFloatingButton:Destroy()
    end
end)

-- Tạo GUI
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "SimpleFloatingButton"
...
Button.MouseButton1Click:Connect(function()
    -- Ẩn/hiện GUI chính (tìm và ẩn tất cả GUI của script)
    pcall(function()
        for _, gui in pairs(game.CoreGui:GetChildren()) do
            if gui.Name ~= "SimpleFloatingButton" and gui:IsA("ScreenGui") then
    ...
    if isVisible then
        Button.BackgroundColor3 = Color3.fromRGB(100, 100, 100) -- Màu xám khi ẩn
        isVisible = false
    else
        Button.BackgroundColor3 = Color3.fromRGB(255, 50, 50) -- Màu đỏ khi hiện
        isVisible = true
    end
end)

-- Thêm hiệu ứng rung nhẹ khi chạm (cho Android)
...
print("✅ Nút bấm phụ Android đã được thêm!")
                    end
                end
            end
        end
